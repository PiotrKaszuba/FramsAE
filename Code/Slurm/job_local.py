...
dataFolderPath = 'tempDataFolders'
# out = 'tempOUT'
...
home = str(Path.home())
data_dir = os.path.join(os.getcwd(), 'tempDataFolders')
...
for param in params:
    ...
    config = get_config(model_name, representation, None, int(cells), twoLayer, bidir, param_data, read_directory,
                        onlyEval=onlyEval)
    prepareTrain(config)
